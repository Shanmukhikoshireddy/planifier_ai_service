...
@router.get("/checkuploadprocess/{upload_job_id}")
def check_upload_progress(upload_job_id: str):
...
@router.get("/upload/{resume_id}")
def get_upload(resume_id: str):
...
def delete_upload(resume_id: str):
